...
import com.ClauseMessage;
import com.DiscourseMessage;
...
public class CorolaMappings {
    ...
    public void start() {
        String message = "";
        ClauseMessage clauseMessage = new ClauseMessage();
        message = message + clauseMessage.getMessage();

        DiscourseMessage discourseMessage = new DiscourseMessage();
        message = message + discourseMessage.getMessage();
